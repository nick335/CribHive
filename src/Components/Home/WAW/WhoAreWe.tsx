...
const WhoAreWe = () => {
  return (
    <section className={`mt-12  h-[309px] relative font-jhengHei flex md:mx-0  md:px-6 md:py-8 md:flex md:items-center md:justify-center md:h-fit lg:px-[5%] ${styles.background} pt-4`}>
     <ResponsiveImage 
        url={Photo}
        alt={'who we are'}
        style={styles.photo}
