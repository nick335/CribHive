...
const HowToUse = () => {
 ...
 function displayClientSteps(){
  ...
  return (
    <section className=' font-jhengHei relative mt-12 md:px-6 md:bg-bgLight md:pt-12'>
      <div className='flex items-center justify-center md:relative md:h-[34px]'>
        <h2 className='text-center font-bold text-lg text-headerPrimary md:text-xl'>How to Use Cribhive</h2>
        <div className='absolute top-[14.12rem] left-2/4 -translate-x-2/4 z-10 w-[11.625rem] mx-auto border border-headerPrimary flex px-3.5 text-xs items-center text-center rounded md:mx-0 md:ml-auto lg:text-lg lg:w-[18.5rem] lg:px-6 lg:mx-0 md:top-0 md:right-0 md:translate-x-0'>
      ...
      <div className=' mt-3 mx-6 bg-bgLight h-[390px] relative pt-4 md:mx-0 md:bg-transparent md:mt-8 md:flex md:items-center md:justify-start md:h-fit'>
        ...
        <div className='shadow-overflowdiv bg-bgPrimary absolute -left-6 top-[130px] min-h-28 py-4 w-screen md:static md:w-2/4 md:min:w-2/4 md:rounded-lg md:min-h-0 md:h-fit md:bg-transparent justify-start'>
          <div className=' md:w-[140%] md:min-w-[140%] md:z-30 md:-ml-[40%] md:relative md:bg-bgPrimary min-h-[12.625rem] md:px-2 md:rounded-lg md:pt-4'>
              ...
              >
                <div ref={nodeRef} className=''>
                  <h3 className='text-lg font-bold text-center md:text-xl'>
                    {agentStepsDisplay ? 'How to add apartment' : 'How to Use'}
                  </h3>
                </div>
              </CSSTransition>
            </SwitchTransition>
